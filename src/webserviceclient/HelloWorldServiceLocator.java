...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements webserviceclient.HelloWorldService {
    ...
    public webserviceclient.HelloWorld_PortType getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public webserviceclient.HelloWorld_PortType getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webserviceclient.HelloWorldSoapBindingStub _stub = new webserviceclient.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webserviceclient.HelloWorld_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                webserviceclient.HelloWorldSoapBindingStub _stub = new webserviceclient.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
